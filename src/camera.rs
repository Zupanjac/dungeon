...
impl Camera {
    pub fn new(player_position: Point) -> Self {
        Self {
            ...
            top_y: player_position.y - DISPLAY_HIGHT / 2,
            botton_y: player_position.y + DISPLAY_HIGHT / 2,
        }
    }
    ...
    pub fn on_player_move(&mut self, player_position: Point) {
        ...
        self.top_y = player_position.y - DISPLAY_HIGHT / 2;
        self.botton_y = player_position.y + DISPLAY_HIGHT / 2;
    }
}
